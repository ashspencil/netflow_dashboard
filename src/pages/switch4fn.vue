      ...
      alignments: [
        ...
        },
        {
          ...
          port: [
            {
              name: 'port-49',
              graph: '這是lab-25的port1'
            },
            {
              name: 'port-50',
              graph: '這是lab-25的port2'
            }
          ]
        }
      ]
  ...
  methods: {
    getDatas () {
      getSnmpWalkAll({
        ...
        .then(response => {
          this.ifAdminStatusDatas = response.data.admin.slice(0, 50)
          this.ifOperStatusDatas = response.data.oper.slice(0, 50)
          this.ifOperSuspendedStatusDatas = response.data.suspended.slice(0, 50)
